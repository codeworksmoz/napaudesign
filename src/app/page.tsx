  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-7xl mx-auto space-y-16">
            <div className="text-center space-y-4 max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-6xl font-headline font-bold tracking-tight">O Que Criamos</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
              {[
                ...
                <div key={i} className="p-10 rounded-[2.5rem] bg-secondary/5 space-y-6 border border-border/40 hover:shadow-xl transition-all duration-500 group hover:-translate-y-2 hover:bg-white">
          ...
          <div className="max-w-7xl mx-auto space-y-12">
            <div className="flex flex-col md:flex-row justify-between items-end gap-6">
              <div className="space-y-2">
                <h3 className="text-4xl md:text-6xl font-headline font-bold">Criações Recentes</h3>
              </div>
              <Button asChild variant="link" className="text-primary font-bold text-xl p-0 h-auto flex items-center gap-2 group mb-1">
                <Link href="/portfolio">
                  Ver Tudo
        ...
        {/* CONTACT CTA */}
        <section id="contact" className="py-24 px-6 bg-primary text-white text-center overflow-hidden relative">
          <div className="absolute inset-0 opacity-10 pointer-events-none">
            {home.heroImage && <Image src={home.heroImage} alt="Background Texture" fill className="object-cover" />}
          </div>
          <div className="max-w-4xl mx-auto space-y-8 relative z-10">
            <h2 className="text-4xl md:text-7xl font-headline font-bold leading-tight">Vamos criar algo único?</h2>
            <p className="text-primary-foreground/80 text-lg md:text-xl font-light">Solicite o seu orçamento personalizado para topos de bolo ou camisetas.</p>
            <div className="pt-6">
              <Button asChild className="bg-white text-primary hover:bg-white/90 rounded-full px-12 py-8 text-xl font-bold shadow-2xl transition-all hover:scale-105 active:scale-95">
                <a 
                  href={`https://wa.me/258847615871?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre os topos de bolo e camisetas da Napau.')}`}
                  target="_blank"
