        ...
        <section className="py-16 md:py-24 px-4 sm:px-6 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12">
            ...
            <div className="p-6 md:p-8 rounded-3xl bg-secondary/20 space-y-4 border border-border/50 transition-transform hover:scale-[1.02] sm:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-xl md:text-2xl font-headline font-bold">Revendedores</h3>
              <p className="text-sm md:text-base text-muted-foreground font-light">Condições especiais para quem quer levar a arte e qualidade da Napau para o seu próprio negócio.</p>
            </div>
          </div>
        </section>
